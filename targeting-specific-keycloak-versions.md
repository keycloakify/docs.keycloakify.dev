...
</strong><strong>            "22-to-25": false,
</strong><strong>            "all-other-versions": "my-keycloak-theme.jar"
</strong><strong>        }
</strong>    })]
});
</code></pre>
...
In this configuration only the  one jar will be generated by `npx keycloakify build` and the file will be: dist\_keycloak/my-keycloak-theme.jar.
