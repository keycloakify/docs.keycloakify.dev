...
* **If you had Keycloakify installed in your web app:**\
  Follow this integration guide: [Integrating Keycloakify in your React project](broken-reference).
...
You now have the option to choose between a Single Page Account Theme or a Multi-Page Account Theme. [See documentation](broken-reference).
